        ...
        <div class="min-w-0 flex-auto">
          ...
          <div class="mt-1 flex items-center gap-x-1.5 sm:hidden">
            ...
            <div class="flex items-center">
              ...
              <!-- rating -->
              <p class="text-xs text-gray-500 dark:text-white">{{ school.review_rating_avg ? school.review_rating_avg.toFixed(2) : 'N/A'   }}</p>
                   </div>
          </div>
...
const items = computed(() => {
  return [
    ...
    {
      title: id[0].toUpperCase() + id.slice(1).toLowerCase(),
      disabled: true,
      href: '/',
    }
]})
